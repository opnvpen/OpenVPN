...
if [[ "${action}" == "clearall" ]]; then
	...
	clear
	echo
	echo  -e " ${Morg}${Blue}Bargello [SSpro Control]${Font_color_suffix} "
	echo
...
${Blue}|${Font_color_suffix}${Blue}16.${Font_color_suffix} ${Yellow}Создать алиасы${Font_color_suffix}                  ${Blue}|${Font_color_suffix}
${Blue}|————————————————————————————————————|${Font_color_suffix}
 "
